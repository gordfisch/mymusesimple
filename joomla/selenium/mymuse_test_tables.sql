...
--
-- Host: localhost
-- Generation Time: Sep 19, 2018 at 02:39 PM
...
--
-- Table structure for table `bf7gn_mymuse_country`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_country`;
CREATE TABLE `bf7gn_mymuse_country` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_mymuse_country`
--

INSERT INTO `bf7gn_mymuse_country` (`id`, `bloc`, `plugin`, `country_name`, `country_3_code`, `country_2_code`, `ordering`) VALUES
...
--
-- Table structure for table `bf7gn_mymuse_coupon`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_coupon`;
CREATE TABLE `bf7gn_mymuse_coupon` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bf7gn_mymuse_currency`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_currency`;
CREATE TABLE `bf7gn_mymuse_currency` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_mymuse_currency`
--

INSERT INTO `bf7gn_mymuse_currency` (`id`, `currency_name`, `currency_code`, `symbol`) VALUES
(1, 'US Dollar', 'USD', '$'),
...
--
-- Table structure for table `bf7gn_mymuse_downloads`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_downloads`;
CREATE TABLE `bf7gn_mymuse_downloads` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bf7gn_mymuse_order`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_order`;
CREATE TABLE `bf7gn_mymuse_order` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bf7gn_mymuse_order_item`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_order_item`;
CREATE TABLE `bf7gn_mymuse_order_item` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bf7gn_mymuse_order_payment`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_order_payment`;
CREATE TABLE `bf7gn_mymuse_order_payment` (
  `id` int(10) NOT NULL,
  `order_id` int(11) NOT NULL,
...
--
-- Table structure for table `bf7gn_mymuse_order_shipping`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_order_shipping`;
CREATE TABLE `bf7gn_mymuse_order_shipping` (
  `id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
...
--
-- Table structure for table `bf7gn_mymuse_order_status`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_order_status`;
CREATE TABLE `bf7gn_mymuse_order_status` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_mymuse_order_status`
--

INSERT INTO `bf7gn_mymuse_order_status` (`id`, `code`, `name`, `ordering`) VALUES
(1, 'P', 'Pending', 1),
(2, 'C', 'Confirmed', 2),
(3, 'X', 'Cancelled', 3),
(4, 'S', 'Shipped', 4),
...
--
-- Table structure for table `bf7gn_mymuse_product`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_product`;
CREATE TABLE `bf7gn_mymuse_product` (
  ...
  `title_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `product_special` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_weight` decimal(10,4) DEFAULT NULL,
  `product_weight_uom` varchar(7) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_length` decimal(10,4) DEFAULT NULL,
  `product_width` decimal(10,4) DEFAULT NULL,
  `product_height` decimal(10,4) DEFAULT NULL,
  `product_lwh_uom` varchar(7) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_default` int(1) DEFAULT '0',
  `product_made_date` date DEFAULT '0000-00-00',
  `product_full_time` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_country` char(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_publisher` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_producer` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_studio` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_name` text CHARACTER SET utf8,
  `file_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_preview` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `file_preview_2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `file_preview_3` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `file_preview_4` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Dumping data for table `bf7gn_mymuse_product`
--

INSERT INTO `bf7gn_mymuse_product` (`id`, `asset_id`, `parentid`, `title`, `product_sku`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `catid`, `artistid`, `price`, `product_discount`, `list_image`, `detail_image`, `product_images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `product_physical`, `product_downloadable`, `product_allfiles`, `product_in_stock`, `product_special`, `product_weight`, `product_weight_uom`, `product_length`, `product_width`, `product_height`, `product_lwh_uom`, `product_default`, `product_made_date`, `product_full_time`, `product_country`, `product_publisher`, `product_producer`, `product_studio`, `file_name`, `file_type`, `file_preview`, `file_preview_2`, `file_preview_3`, `file_preview_4`, `featured`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `xreference`) VALUES
(32, 189, 0, 'Are You My Sister', 'are-you-my-sister', 'are-you-my-sister', '', '<p>Description: The great first album . Description: The great first album . Description: The great first album . Description: The great first album . Description: The great first album . Description: The great first album . Description: The great first album . Description: The great first album . Description: The great first album . </p>\r\n<p> </p>\r\n<p>Description: The great first album . Description: The great first album . Description: The great first album . Description: The great first album . </p>', '', 1, 66, 65, '20.0000', 0.00, 'images/mymuse/sister.jpg', 'images/mymuse/sister.jpg', '', '', '{"media_rls":"","media_link":""}', 1, 11, 'celtic, nuts', 'Iron Brew first CD', 1, 25, '{"robots":"","author":"Gord Fisch","rights":"","xreference":""}', 1, 0, 0, 5, NULL, '0.5000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '2018-09-17', '32:11', 'CA', 'Iron Filings', 'Gord Fisch', 'Tanglewood', NULL, '', '', '', '', '', 1, '*', '2018-09-13 20:03:42', 687, '', '2018-09-19 18:21:13', 687, 0, '0000-00-00 00:00:00', '2018-09-13 20:03:42', '0000-00-00 00:00:00', ''),
(112, 270, 0, 'Hoodie Items', 'hoodie-items-112', 'hoodie-items', '', '<p>Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. </p>\r\n<p>Our hoodies are the best. Our hoodies are the best. Our hoodies are the best. </p>', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 12, '', '', 1, 1, '{"robots":"","author":"","rights":"","xreference":""}', 0, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 1, '*', '2018-09-17 20:53:15', 687, '', '2018-09-18 20:07:20', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(113, 271, 112, 'Hoodie Items-S-Burgundy', 'hoodie-items-112', 'hoodie-items-s-burgundy', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 13, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 20:56:28', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(114, 272, 112, 'Hoodie Items-S-Blue', 'hoodie-items-112', 'hoodie-items-s-blue', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_blue_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 14, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 21:15:00', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(115, 273, 112, 'Hoodie Items-S-Black', 'hoodie-items-112', 'hoodie-items-s-black', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_black_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 15, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 21:15:14', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(116, 274, 112, 'Hoodie Items-M-Burgundy', 'hoodie-items-112', 'hoodie-items-m-burgundy', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 16, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 20:56:28', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(117, 275, 112, 'Hoodie Items-M-Blue', 'hoodie-items-112', 'hoodie-items-m-blue', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_blue_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 17, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 21:15:29', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(118, 276, 112, 'Hoodie Items-M-Black', 'hoodie-items-112', 'hoodie-items-m-black', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_black_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 18, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 21:15:46', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(119, 277, 112, 'Hoodie Items-L-Burgundy', 'hoodie-items-112', 'hoodie-items-l-burgundy', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 19, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 20:56:28', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(120, 278, 112, 'Hoodie Items-L-Blue', 'hoodie-items-112', 'hoodie-items-l-blue', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_blue_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 20, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 21:15:58', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(121, 279, 112, 'Hoodie Items-L-Black', 'hoodie-items-112', 'hoodie-items-l-black', '', '', '', 1, 67, 65, '0.0000', 0.00, 'images/A_MyMuseImages/hoodie1/hoodie_burgundy_front_800.png', 'images/A_MyMuseImages/hoodie1/hoodie_black_front_800.png', 'A_MyMuseImages/hoodie1', '', '{"media_rls":"","media_link":""}', 1, 21, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 1, 0, 0, 0, NULL, '2.0000', 'LBS', '12.0000', '8.0000', '2.0000', 'IN', 0, '0000-00-00', '', '', '', '', '', NULL, '', '', '', '', '', 0, '*', '2018-09-17 20:53:15', 687, '', '2018-09-17 21:16:19', 687, 0, '0000-00-00 00:00:00', '2018-09-17 20:53:15', '0000-00-00 00:00:00', ''),
(122, 280, 0, 'My Great Vinyl Album', 'my-great-vinyl-album-122', 'my-great-vinyl-album', '', '<p>My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. </p>\r\n<p>My great Vinyl album. My great Vinyl album. My great Vinyl album. My great Vinyl album. </p>', '', 1, 67, 65, '27.0000', 0.00, 'images/A_MyMuseImages/vinyl_generic.jpg', 'images/A_MyMuseImages/vinyl_generic.jpg', '', '', '{"media_rls":"","media_link":""}', 1, 22, 'vinyl, keywird', 'Vinyl meta description', 1, 10, '{"robots":"","author":"Gord Fisch","rights":"Open Source","xreference":""}', 1, 0, 0, 6, NULL, '0.5000', 'LBS', '12.0000', '12.0000', '0.5000', 'IN', 0, '2018-08-26', '42:01', 'CA', 'My Publisher', 'My Producer', 'My Studio', NULL, '', '', '', '', '', 1, '*', '2018-09-17 21:22:48', 687, '', '2018-09-18 20:02:36', 687, 0, '0000-00-00 00:00:00', '2018-09-17 21:22:48', '0000-00-00 00:00:00', '');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_mymuse_product_attribute`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_product_attribute`;
CREATE TABLE `bf7gn_mymuse_product_attribute` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_mymuse_product_attribute`
--

INSERT INTO `bf7gn_mymuse_product_attribute` (`id`, `product_id`, `product_attribute_sku_id`, `attribute_name`, `attribute_value`) VALUES
(1, 2, 1, 'Size', 'S'),
(2, 2, 2, 'Color', 'Red'),
(3, 3, 1, 'Size', 'S'),
(4, 3, 2, 'Color', 'Green'),
...
(62, 24, 2, 'Color', 'Green'),
(209, 113, 14, 'Size', 'S'),
(210, 113, 15, 'Color', 'Burgundy'),
(215, 116, 14, 'Size', 'M'),
(216, 116, 15, 'Color', 'Burgundy'),
(221, 119, 14, 'Size', 'L'),
(222, 119, 15, 'Color', 'Burgundy'),
(227, 114, 14, 'Size', 'S'),
(228, 114, 15, 'Color', 'Blue'),
(229, 115, 14, 'Size', 'S'),
(230, 115, 15, 'Color', 'Black'),
(231, 117, 14, 'Size', 'M'),
(232, 117, 15, 'Color', 'Blue'),
(233, 118, 14, 'Size', 'M'),
(234, 118, 15, 'Color', 'Black'),
(235, 120, 14, 'Size', 'L'),
(236, 120, 15, 'Color', 'Blue'),
(237, 121, 14, 'Size', 'L'),
(238, 121, 15, 'Color', 'Black');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_mymuse_product_attribute_sku`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_product_attribute_sku`;
CREATE TABLE `bf7gn_mymuse_product_attribute_sku` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_mymuse_product_attribute_sku`
--

INSERT INTO `bf7gn_mymuse_product_attribute_sku` (`id`, `name`, `product_parent_id`, `ordering`, `extra_base`, `extra_css`) VALUES
(1, 'Size', 1, 1, 'S\r\nM\r\nL\r\n', ''),
(2, 'Color', 1, 2, 'Red\r\nGreen\r\nBlue', '#ff0000\r\n#00ff00\r\n#0000ff'),
(14, 'Size', 112, 3, 'S\r\nM\r\nL', ''),
(15, 'Color', 112, 4, 'Burgundy\r\nBlue\r\nBlack', '#9d1d1e\r\n#3a4e80\r\n#1b1b1b');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_mymuse_product_category_xref`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_product_category_xref`;
CREATE TABLE `bf7gn_mymuse_product_category_xref` (
...
--
-- Table structure for table `bf7gn_mymuse_product_file`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_product_file`;
CREATE TABLE `bf7gn_mymuse_product_file` (
  `id` int(11) UNSIGNED NOT NULL,
  `product_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bf7gn_mymuse_product_rating`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_product_rating`;
CREATE TABLE `bf7gn_mymuse_product_rating` (
  `product_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bf7gn_mymuse_product_recommend_xref`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_product_recommend_xref`;
CREATE TABLE `bf7gn_mymuse_product_recommend_xref` (
  `product_id` int(11) NOT NULL DEFAULT '0',
  `recommend_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bf7gn_mymuse_product_recommend_xref`
--

INSERT INTO `bf7gn_mymuse_product_recommend_xref` (`product_id`, `recommend_id`) VALUES
(32, 112),
(32, 122);
...
--
-- Table structure for table `bf7gn_mymuse_shopper_group`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_shopper_group`;
CREATE TABLE `bf7gn_mymuse_shopper_group` (
  `id` int(11) NOT NULL,
  `shopper_group_name` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `bf7gn_mymuse_shopper_group`
--

INSERT INTO `bf7gn_mymuse_shopper_group` (`id`, `shopper_group_name`, `shopper_group_description`, `discount`, `state`, `checked_out`, `checked_out_time`) VALUES
(1, 'default', 'Ordinary Shoppers', 0, 1, 0, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_mymuse_state`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_state`;
CREATE TABLE `bf7gn_mymuse_state` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_mymuse_state`
--

INSERT INTO `bf7gn_mymuse_state` (`id`, `country_id`, `state_name`, `state_3_code`, `state_2_code`) VALUES
...
--
-- Table structure for table `bf7gn_mymuse_store`
--

DROP TABLE IF EXISTS `bf7gn_mymuse_store`;
CREATE TABLE `bf7gn_mymuse_store` (
  `id` int(11) NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `scope` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `published` tinyint(1) NOT NULL DEFAULT '0',
  `checked_out` int(11) UNSIGNED NOT NULL DEFAULT '0',
  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Indexes for table `bf7gn_mymuse_country`
--
ALTER TABLE `bf7gn_mymuse_country`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_country_name` (`country_name`);

--
-- Indexes for table `bf7gn_mymuse_coupon`
--
ALTER TABLE `bf7gn_mymuse_coupon`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_currency`
--
ALTER TABLE `bf7gn_mymuse_currency`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_currency_name` (`currency_name`);

--
-- Indexes for table `bf7gn_mymuse_downloads`
--
ALTER TABLE `bf7gn_mymuse_downloads`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_product_filename` (`product_filename`);

--
-- Indexes for table `bf7gn_mymuse_order`
--
ALTER TABLE `bf7gn_mymuse_order`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_order_item`
--
ALTER TABLE `bf7gn_mymuse_order_item`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_order_payment`
--
ALTER TABLE `bf7gn_mymuse_order_payment`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_mymuse_order_shipping`
--
ALTER TABLE `bf7gn_mymuse_order_shipping`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_order_status`
--
ALTER TABLE `bf7gn_mymuse_order_status`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_product`
--
ALTER TABLE `bf7gn_mymuse_product`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_mymuse_product_attribute`
--
ALTER TABLE `bf7gn_mymuse_product_attribute`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_product_attribute_sku`
--
ALTER TABLE `bf7gn_mymuse_product_attribute_sku`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_product_file`
--
ALTER TABLE `bf7gn_mymuse_product_file`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_name` (`file_name`);

--
-- Indexes for table `bf7gn_mymuse_product_rating`
--
ALTER TABLE `bf7gn_mymuse_product_rating`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `bf7gn_mymuse_shopper_group`
--
ALTER TABLE `bf7gn_mymuse_shopper_group`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_state`
--
ALTER TABLE `bf7gn_mymuse_state`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_country_id` (`country_id`);

--
-- Indexes for table `bf7gn_mymuse_store`
--
ALTER TABLE `bf7gn_mymuse_store`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_mymuse_tax_rate`
--
ALTER TABLE `bf7gn_mymuse_tax_rate`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_country`
--
ALTER TABLE `bf7gn_mymuse_country`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=245;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_coupon`
--
ALTER TABLE `bf7gn_mymuse_coupon`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_currency`
--
ALTER TABLE `bf7gn_mymuse_currency`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_downloads`
--
ALTER TABLE `bf7gn_mymuse_downloads`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_order`
--
ALTER TABLE `bf7gn_mymuse_order`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_order_item`
--
ALTER TABLE `bf7gn_mymuse_order_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_order_payment`
--
ALTER TABLE `bf7gn_mymuse_order_payment`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_order_shipping`
--
ALTER TABLE `bf7gn_mymuse_order_shipping`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_order_status`
--
ALTER TABLE `bf7gn_mymuse_order_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_product`
--
ALTER TABLE `bf7gn_mymuse_product`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_product_attribute`
--
ALTER TABLE `bf7gn_mymuse_product_attribute`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=239;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_product_attribute_sku`
--
ALTER TABLE `bf7gn_mymuse_product_attribute_sku`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_product_file`
--
ALTER TABLE `bf7gn_mymuse_product_file`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_shopper_group`
--
ALTER TABLE `bf7gn_mymuse_shopper_group`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_state`
--
ALTER TABLE `bf7gn_mymuse_state`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=485;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_store`
--
ALTER TABLE `bf7gn_mymuse_store`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bf7gn_mymuse_tax_rate`
--
ALTER TABLE `bf7gn_mymuse_tax_rate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
