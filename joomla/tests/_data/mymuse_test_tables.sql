...
--
-- Database: `mymuse_test`
--

-- --------------------------------------------------------
DROP TABLE IF EXISTS `bf7gn_mymuse_country`;
DROP TABLE IF EXISTS `bf7gn_mymuse_coupon`;
DROP TABLE IF EXISTS `bf7gn_mymuse_currency`;
DROP TABLE IF EXISTS `bf7gn_mymuse_downloads`;
DROP TABLE IF EXISTS `bf7gn_mymuse_order`;
DROP TABLE IF EXISTS `bf7gn_mymuse_order_item`;
DROP TABLE IF EXISTS `bf7gn_mymuse_order_status`;
DROP TABLE IF EXISTS `bf7gn_mymuse_order_shippint`;
DROP TABLE IF EXISTS `bf7gn_mymuse_order_payment`;
DROP TABLE IF EXISTS `bf7gn_mymuse_product`;
DROP TABLE IF EXISTS `bf7gn_mymuse_product_attribute`;
DROP TABLE IF EXISTS `bf7gn_mymuse_product_attribute_sku`;

DROP TABLE IF EXISTS `bf7gn_mymuse_product_category_xref`;
DROP TABLE IF EXISTS `bf7gn_mymuse_product_recommend_xref`;
DROP TABLE IF EXISTS `bf7gn_mymuse_product_file`;
DROP TABLE IF EXISTS `bf7gn_mymuse_product_rating`;
DROP TABLE IF EXISTS `bf7gn_mymuse_shopper`;
DROP TABLE IF EXISTS `bf7gn_mymuse_shopper_group`;
DROP TABLE IF EXISTS `bf7gn_mymuse_state`;
DROP TABLE IF EXISTS `bf7gn_mymuse_store`;
DROP TABLE IF EXISTS `bf7gn_mymuse_track`;
DROP TABLE IF EXISTS `bf7gn_mymuse_tax_rate`;
DROP TABLE IF EXISTS `bf7gn_mymuse_order_shipping`;

--
-- Table structure for table `bf7gn_action_logs`
--

DROP TABLE IF EXISTS `bf7gn_action_logs`;
CREATE TABLE `bf7gn_action_logs` (
...
--
-- Dumping data for table `bf7gn_action_logs`
--

INSERT INTO `bf7gn_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2018-12-11 14:25:59', 'com_users', 921, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10001,\"name\":\"PLG_MYMUSE_AUDIO_JPLAYER\",\"extension_name\":\"PLG_MYMUSE_AUDIO_JPLAYER\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10001, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10002,\"name\":\"PLG_MYMUSE_DISCOUNT\",\"extension_name\":\"PLG_MYMUSE_DISCOUNT\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10002, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10003,\"name\":\"plg_mymuse_payoffline\",\"extension_name\":\"plg_mymuse_payoffline\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10003, 'COM_ACTIONLOGS_DISABLED'),
(5, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10004,\"name\":\"plg_mymuse_payment_paypal\",\"extension_name\":\"plg_mymuse_payment_paypal\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10004, 'COM_ACTIONLOGS_DISABLED'),
(6, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10005,\"name\":\"plg_search_mymuse\",\"extension_name\":\"plg_search_mymuse\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10005, 'COM_ACTIONLOGS_DISABLED'),
(7, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10006,\"name\":\"plg_mymuse_shipping_standard\",\"extension_name\":\"plg_mymuse_shipping_standard\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10006, 'COM_ACTIONLOGS_DISABLED'),
(8, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10007,\"name\":\"plg_mymuse_shipping_price\",\"extension_name\":\"plg_mymuse_shipping_price\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10007, 'COM_ACTIONLOGS_DISABLED'),
(9, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10008,\"name\":\"USPS Shipping for MyMuse\",\"extension_name\":\"USPS Shipping for MyMuse\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10008, 'COM_ACTIONLOGS_DISABLED'),
(10, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10009,\"name\":\"plg_user_mymuse\",\"extension_name\":\"plg_user_mymuse\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10009, 'COM_ACTIONLOGS_DISABLED'),
(11, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10010,\"name\":\"plg_user_mymusenoreg\",\"extension_name\":\"plg_user_mymusenoreg\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10010, 'COM_ACTIONLOGS_DISABLED'),
(12, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":10011,\"name\":\"plg_user_redirectonlogin\",\"extension_name\":\"plg_user_redirectonlogin\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10011, 'COM_ACTIONLOGS_DISABLED'),
(13, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":10012,\"name\":\"mod_mymuse_latest\",\"extension_name\":\"mod_mymuse_latest\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10012, 'COM_ACTIONLOGS_DISABLED'),
(14, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":10013,\"name\":\"mod_mymuse_minicart\",\"extension_name\":\"mod_mymuse_minicart\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10013, 'COM_ACTIONLOGS_DISABLED'),
(15, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_COMPONENT\",\"id\":10000,\"name\":\"MyMuse\",\"extension_name\":\"MyMuse\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:04', 'com_installer', 921, 10000, 'COM_ACTIONLOGS_DISABLED'),
(16, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_CATEGORY\",\"id\":8,\"title\":\"MyMuse\",\"itemlink\":\"index.php?option=com_categories&task=category.edit&id=8\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:12', 'com_categories.category', 921, 8, 'COM_ACTIONLOGS_DISABLED'),
(17, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_CATEGORY\",\"id\":9,\"title\":\"Artists\",\"itemlink\":\"index.php?option=com_categories&task=category.edit&id=9\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:14', 'com_categories.category', 921, 9, 'COM_ACTIONLOGS_DISABLED'),
(18, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_CATEGORY\",\"id\":10,\"title\":\"Genres\",\"itemlink\":\"index.php?option=com_categories&task=category.edit&id=10\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:16', 'com_categories.category', 921, 10, 'COM_ACTIONLOGS_DISABLED'),
(19, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_CATEGORY\",\"id\":11,\"title\":\"Iron Brew\",\"itemlink\":\"index.php?option=com_categories&task=category.edit&id=11\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:19', 'com_categories.category', 921, 11, 'COM_ACTIONLOGS_DISABLED'),
(20, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_CATEGORY\",\"id\":12,\"title\":\"World Beat\",\"itemlink\":\"index.php?option=com_categories&task=category.edit&id=12\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 14:26:21', 'com_categories.category', 921, 12, 'COM_ACTIONLOGS_DISABLED'),
(21, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2018-12-11 14:28:11', 'com_users', 921, 0, 'COM_ACTIONLOGS_DISABLED'),
(22, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_ARTICLE\",\"id\":1,\"title\":\"test\",\"itemlink\":\"index.php?option=com_content&task=article.edit&id=1\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 15:08:49', 'com_content.article', 921, 1, 'COM_ACTIONLOGS_DISABLED'),
(23, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_TRASHED', '{\"action\":\"trash\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_ARTICLE\",\"id\":1,\"title\":\"test\",\"itemlink\":\"index.php?option=com_content&task=article.edit&id=1\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 15:08:53', 'com_content.article', 921, 1, 'COM_ACTIONLOGS_DISABLED'),
(24, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_DELETED', '{\"action\":\"delete\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_ARTICLE\",\"id\":1,\"title\":\"test\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 15:09:04', 'com_content.article', 921, 1, 'COM_ACTIONLOGS_DISABLED'),
(25, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2018-12-11 18:06:39', 'com_users', 921, 0, 'COM_ACTIONLOGS_DISABLED'),
(26, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10001\",\"name\":\"PLG_MYMUSE_AUDIO_JPLAYER\",\"extension_name\":\"PLG_MYMUSE_AUDIO_JPLAYER\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10001, 'COM_ACTIONLOGS_DISABLED'),
(27, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10002\",\"name\":\"PLG_MYMUSE_DISCOUNT\",\"extension_name\":\"PLG_MYMUSE_DISCOUNT\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10002, 'COM_ACTIONLOGS_DISABLED'),
(28, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10003\",\"name\":\"plg_mymuse_payoffline\",\"extension_name\":\"plg_mymuse_payoffline\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10003, 'COM_ACTIONLOGS_DISABLED'),
(29, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10004\",\"name\":\"plg_mymuse_payment_paypal\",\"extension_name\":\"plg_mymuse_payment_paypal\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10004, 'COM_ACTIONLOGS_DISABLED'),
(30, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10005\",\"name\":\"plg_search_mymuse\",\"extension_name\":\"plg_search_mymuse\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10005, 'COM_ACTIONLOGS_DISABLED'),
(31, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10006\",\"name\":\"plg_mymuse_shipping_standard\",\"extension_name\":\"plg_mymuse_shipping_standard\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10006, 'COM_ACTIONLOGS_DISABLED'),
(32, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10007\",\"name\":\"plg_mymuse_shipping_price\",\"extension_name\":\"plg_mymuse_shipping_price\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10007, 'COM_ACTIONLOGS_DISABLED'),
(33, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10008\",\"name\":\"USPS Shipping for MyMuse\",\"extension_name\":\"USPS Shipping for MyMuse\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10008, 'COM_ACTIONLOGS_DISABLED'),
(34, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10009\",\"name\":\"plg_user_mymuse\",\"extension_name\":\"plg_user_mymuse\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10009, 'COM_ACTIONLOGS_DISABLED'),
(35, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10010\",\"name\":\"plg_user_mymusenoreg\",\"extension_name\":\"plg_user_mymusenoreg\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10010, 'COM_ACTIONLOGS_DISABLED'),
(36, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":\"10011\",\"name\":\"plg_user_redirectonlogin\",\"extension_name\":\"plg_user_redirectonlogin\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10011, 'COM_ACTIONLOGS_DISABLED'),
(37, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":\"10012\",\"name\":\"mod_mymuse_latest\",\"extension_name\":\"mod_mymuse_latest\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10012, 'COM_ACTIONLOGS_DISABLED'),
(38, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":\"10013\",\"name\":\"mod_mymuse_minicart\",\"extension_name\":\"mod_mymuse_minicart\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10013, 'COM_ACTIONLOGS_DISABLED'),
(39, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_UNINSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_COMPONENT\",\"id\":\"10000\",\"name\":\"MyMuse\",\"extension_name\":\"MyMuse\",\"userid\":\"921\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=921\"}', '2018-12-11 18:07:03', 'com_installer', 921, 10000, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_action_logs_extensions`
--

DROP TABLE IF EXISTS `bf7gn_action_logs_extensions`;
CREATE TABLE `bf7gn_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bf7gn_action_logs_extensions`
--

INSERT INTO `bf7gn_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Table structure for table `bf7gn_action_logs_users`
--

DROP TABLE IF EXISTS `bf7gn_action_logs_users`;
CREATE TABLE `bf7gn_action_logs_users` (
...
--
-- Table structure for table `bf7gn_action_log_config`
--

DROP TABLE IF EXISTS `bf7gn_action_log_config`;
CREATE TABLE `bf7gn_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `bf7gn_action_log_config`
--

INSERT INTO `bf7gn_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Table structure for table `bf7gn_assets`
--

DROP TABLE IF EXISTS `bf7gn_assets`;
CREATE TABLE `bf7gn_assets` (
...
--
-- Dumping data for table `bf7gn_assets`
--

INSERT INTO `bf7gn_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `bf7gn_associations`
--

DROP TABLE IF EXISTS `bf7gn_associations`;
CREATE TABLE `bf7gn_associations` (
...
--
-- Table structure for table `bf7gn_banners`
--

DROP TABLE IF EXISTS `bf7gn_banners`;
CREATE TABLE `bf7gn_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bf7gn_banner_clients`
--

DROP TABLE IF EXISTS `bf7gn_banner_clients`;
CREATE TABLE `bf7gn_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `bf7gn_banner_tracks`
--

DROP TABLE IF EXISTS `bf7gn_banner_tracks`;
CREATE TABLE `bf7gn_banner_tracks` (
...
--
-- Table structure for table `bf7gn_categories`
--

DROP TABLE IF EXISTS `bf7gn_categories`;
CREATE TABLE `bf7gn_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_categories`
--

INSERT INTO `bf7gn_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 921, '2018-12-10 20:11:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 921, '2018-12-10 20:11:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 921, '2018-12-10 20:11:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 921, '2018-12-10 20:11:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 921, '2018-12-10 20:11:26', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 921, '2018-12-10 20:11:26', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_contact_details`
--

DROP TABLE IF EXISTS `bf7gn_contact_details`;
CREATE TABLE `bf7gn_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `bf7gn_content`
--

DROP TABLE IF EXISTS `bf7gn_content`;
CREATE TABLE `bf7gn_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `bf7gn_contentitem_tag_map`
--

DROP TABLE IF EXISTS `bf7gn_contentitem_tag_map`;
CREATE TABLE `bf7gn_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `bf7gn_content_frontpage`
--

DROP TABLE IF EXISTS `bf7gn_content_frontpage`;
CREATE TABLE `bf7gn_content_frontpage` (
...
--
-- Table structure for table `bf7gn_content_rating`
--

DROP TABLE IF EXISTS `bf7gn_content_rating`;
CREATE TABLE `bf7gn_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bf7gn_content_types`
--

DROP TABLE IF EXISTS `bf7gn_content_types`;
CREATE TABLE `bf7gn_content_types` (
...
--
-- Dumping data for table `bf7gn_content_types`
--

INSERT INTO `bf7gn_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `bf7gn_core_log_searches`
--

DROP TABLE IF EXISTS `bf7gn_core_log_searches`;
CREATE TABLE `bf7gn_core_log_searches` (
...
--
-- Table structure for table `bf7gn_extensions`
--

DROP TABLE IF EXISTS `bf7gn_extensions`;
CREATE TABLE `bf7gn_extensions` (
...
--
-- Dumping data for table `bf7gn_extensions`
--

INSERT INTO `bf7gn_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(13, 0, 'com_media', 'component', 'com_media', '', 1, 1, 0, 1, '{\"name\":\"com_media\",\"type\":\"component\",\"creationDate\":\"April 2006\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.0.0\",\"description\":\"COM_MEDIA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"media\"}', '{\"upload_extensions\":\"bmp,csv,doc,gif,ico,jpg,jpeg,odg,odp,ods,odt,pdf,png,ppt,txt,xcf,xls,BMP,CSV,DOC,GIF,ICO,JPG,JPEG,ODG,ODP,ODS,ODT,PDF,PNG,PPT,TXT,XCF,XLS,mp3,MP3,wav,WAV\",\"upload_maxsize\":\"10\",\"file_path\":\"images\",\"image_path\":\"images\",\"restrict_uploads\":\"1\",\"allowed_media_usergroup\":\"3\",\"check_mime\":\"1\",\"image_extensions\":\"bmp,gif,jpg,png\",\"ignore_extensions\":\"mp3,wav\",\"upload_mime\":\"image/jpeg,image/gif,image/png,image/bmp,application/msword,application/excel,application/pdf,application/powerpoint,text/plain,application/x-zip,audio/mpeg,audio/wav\",\"upload_mime_illegal\":\"text/html\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"ed36cd514b6edbf160c5377fdaa0f12c\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1544538358}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_stats\",\"type\":\"plugin\",\"creationDate\":\"November 2013\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_STATS_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"stats\"}', '{\"mode\":3,\"lastrun\":1544539419,\"unique_id\":\"5e329257feb5a6d61213cde57cb5c06e0a0a3236\",\"interval\":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `bf7gn_fields`
--

DROP TABLE IF EXISTS `bf7gn_fields`;
CREATE TABLE `bf7gn_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_fields_categories`
--

DROP TABLE IF EXISTS `bf7gn_fields_categories`;
CREATE TABLE `bf7gn_fields_categories` (
...
--
-- Table structure for table `bf7gn_fields_groups`
--

DROP TABLE IF EXISTS `bf7gn_fields_groups`;
CREATE TABLE `bf7gn_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `bf7gn_fields_values`
--

DROP TABLE IF EXISTS `bf7gn_fields_values`;
CREATE TABLE `bf7gn_fields_values` (
...
--
-- Table structure for table `bf7gn_finder_filters`
--

DROP TABLE IF EXISTS `bf7gn_finder_filters`;
CREATE TABLE `bf7gn_finder_filters` (
...
--
-- Table structure for table `bf7gn_finder_links`
--

DROP TABLE IF EXISTS `bf7gn_finder_links`;
CREATE TABLE `bf7gn_finder_links` (
...
--
-- Table structure for table `bf7gn_finder_links_terms0`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms0`;
CREATE TABLE `bf7gn_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_finder_links_terms1`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms1`;
CREATE TABLE `bf7gn_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_terms2`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms2`;
CREATE TABLE `bf7gn_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_terms3`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms3`;
CREATE TABLE `bf7gn_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_terms4`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms4`;
CREATE TABLE `bf7gn_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_terms5`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms5`;
CREATE TABLE `bf7gn_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_terms6`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms6`;
CREATE TABLE `bf7gn_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_terms7`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms7`;
CREATE TABLE `bf7gn_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_terms8`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms8`;
CREATE TABLE `bf7gn_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_terms9`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_terms9`;
CREATE TABLE `bf7gn_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_termsa`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_termsa`;
CREATE TABLE `bf7gn_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_termsb`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_termsb`;
CREATE TABLE `bf7gn_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_termsc`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_termsc`;
CREATE TABLE `bf7gn_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_termsd`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_termsd`;
CREATE TABLE `bf7gn_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_termse`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_termse`;
CREATE TABLE `bf7gn_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_links_termsf`
--

DROP TABLE IF EXISTS `bf7gn_finder_links_termsf`;
CREATE TABLE `bf7gn_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `bf7gn_finder_taxonomy`
--

DROP TABLE IF EXISTS `bf7gn_finder_taxonomy`;
CREATE TABLE `bf7gn_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `bf7gn_finder_taxonomy`
--

INSERT INTO `bf7gn_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `bf7gn_finder_taxonomy_map`;
CREATE TABLE `bf7gn_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_finder_terms`
--

DROP TABLE IF EXISTS `bf7gn_finder_terms`;
CREATE TABLE `bf7gn_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_finder_terms_common`
--

DROP TABLE IF EXISTS `bf7gn_finder_terms_common`;
CREATE TABLE `bf7gn_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `bf7gn_finder_terms_common`
--

INSERT INTO `bf7gn_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `bf7gn_finder_tokens`
--

DROP TABLE IF EXISTS `bf7gn_finder_tokens`;
CREATE TABLE `bf7gn_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bf7gn_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `bf7gn_finder_tokens_aggregate`;
CREATE TABLE `bf7gn_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_finder_types`
--

DROP TABLE IF EXISTS `bf7gn_finder_types`;
CREATE TABLE `bf7gn_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `bf7gn_finder_types`
--

INSERT INTO `bf7gn_finder_types` (`id`, `title`, `mime`) VALUES
(1, 'Tag', ''),
(2, 'Category', ''),
(3, 'Contact', ''),
(4, 'Article', ''),
...
--
-- Table structure for table `bf7gn_languages`
--

DROP TABLE IF EXISTS `bf7gn_languages`;
CREATE TABLE `bf7gn_languages` (
...
--
-- Dumping data for table `bf7gn_languages`
--

INSERT INTO `bf7gn_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_menu`
--

DROP TABLE IF EXISTS `bf7gn_menu`;
CREATE TABLE `bf7gn_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_menu`
--

INSERT INTO `bf7gn_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `bf7gn_menu_types`
--

DROP TABLE IF EXISTS `bf7gn_menu_types`;
CREATE TABLE `bf7gn_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `bf7gn_menu_types`
--

INSERT INTO `bf7gn_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_messages`
--

DROP TABLE IF EXISTS `bf7gn_messages`;
CREATE TABLE `bf7gn_messages` (
...
--
-- Table structure for table `bf7gn_messages_cfg`
--

DROP TABLE IF EXISTS `bf7gn_messages_cfg`;
CREATE TABLE `bf7gn_messages_cfg` (
...
--
-- Table structure for table `bf7gn_modules`
--

DROP TABLE IF EXISTS `bf7gn_modules`;
CREATE TABLE `bf7gn_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `bf7gn_modules`
--

INSERT INTO `bf7gn_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `bf7gn_modules_menu`
--

DROP TABLE IF EXISTS `bf7gn_modules_menu`;
CREATE TABLE `bf7gn_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bf7gn_modules_menu`
--

INSERT INTO `bf7gn_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `bf7gn_newsfeeds`
--

DROP TABLE IF EXISTS `bf7gn_newsfeeds`;
CREATE TABLE `bf7gn_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_overrider`
--

DROP TABLE IF EXISTS `bf7gn_overrider`;
CREATE TABLE `bf7gn_overrider` (
...
--
-- Table structure for table `bf7gn_postinstall_messages`
--

DROP TABLE IF EXISTS `bf7gn_postinstall_messages`;
CREATE TABLE `bf7gn_postinstall_messages` (
...
--
-- Dumping data for table `bf7gn_postinstall_messages`
--

INSERT INTO `bf7gn_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `bf7gn_privacy_consents`
--

DROP TABLE IF EXISTS `bf7gn_privacy_consents`;
CREATE TABLE `bf7gn_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bf7gn_privacy_requests`
--

DROP TABLE IF EXISTS `bf7gn_privacy_requests`;
CREATE TABLE `bf7gn_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_redirect_links`
--

DROP TABLE IF EXISTS `bf7gn_redirect_links`;
CREATE TABLE `bf7gn_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_schemas`
--

DROP TABLE IF EXISTS `bf7gn_schemas`;
CREATE TABLE `bf7gn_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bf7gn_schemas`
--

INSERT INTO `bf7gn_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.0-2018-10-21');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_session`
--

DROP TABLE IF EXISTS `bf7gn_session`;
CREATE TABLE `bf7gn_session` (
...
--
-- Dumping data for table `bf7gn_session`
--

INSERT INTO `bf7gn_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x75337332686738666172346e3774763937746264396f76716631, 1, 0, 1544551649, 'joomla|s:1272:\"\";', 921, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_tags`
--

DROP TABLE IF EXISTS `bf7gn_tags`;
CREATE TABLE `bf7gn_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `bf7gn_tags`
--

INSERT INTO `bf7gn_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 921, '2018-12-10 20:11:26', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_template_styles`
--

DROP TABLE IF EXISTS `bf7gn_template_styles`;
CREATE TABLE `bf7gn_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `bf7gn_template_styles`
--

INSERT INTO `bf7gn_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `bf7gn_ucm_base`
--

DROP TABLE IF EXISTS `bf7gn_ucm_base`;
CREATE TABLE `bf7gn_ucm_base` (
...
--
-- Table structure for table `bf7gn_ucm_content`
--

DROP TABLE IF EXISTS `bf7gn_ucm_content`;
CREATE TABLE `bf7gn_ucm_content` (
...
--
-- Table structure for table `bf7gn_ucm_history`
--

DROP TABLE IF EXISTS `bf7gn_ucm_history`;
CREATE TABLE `bf7gn_ucm_history` (
...
--
-- Table structure for table `bf7gn_updates`
--

DROP TABLE IF EXISTS `bf7gn_updates`;
CREATE TABLE `bf7gn_updates` (
...
--
-- Dumping data for table `bf7gn_updates`
--

INSERT INTO `bf7gn_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 2, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.9.1.2', '', 'https://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(2, 2, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(3, 2, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(4, 2, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(5, 2, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.9.0.1', '', 'https://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(6, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.7.1.1', '', 'https://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
(7, 2, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
(8, 2, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.2', '', 'https://update.joomla.org/language/details3/sq-AL_details.xml', '', ''),
(9, 2, 0, 'Basque', '', 'pkg_eu-ES', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/eu-ES_details.xml', '', ''),
(10, 2, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '3.3.6.2', '', 'https://update.joomla.org/language/details3/hi-IN_details.xml', '', ''),
(11, 2, 0, 'German DE', '', 'pkg_de-DE', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(12, 2, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(13, 2, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(14, 2, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.9.0.1', '', 'https://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(15, 2, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(16, 2, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(17, 2, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.2', '', 'https://update.joomla.org/language/details3/vi-VN_details.xml', '', ''),
(18, 2, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(19, 2, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.8.1.1', '', 'https://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(20, 2, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(21, 2, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.2', '', 'https://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(22, 2, 0, 'English CA', '', 'pkg_en-CA', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(23, 2, 0, 'French CA', '', 'pkg_fr-CA', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
(24, 2, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
(25, 2, 0, 'Sinhala', '', 'pkg_si-LK', 'package', '', 0, '3.3.1.2', '', 'https://update.joomla.org/language/details3/si-LK_details.xml', '', ''),
(26, 2, 0, 'Dari Persian', '', 'pkg_prs-AF', 'package', '', 0, '3.4.4.2', '', 'https://update.joomla.org/language/details3/prs-AF_details.xml', '', ''),
(27, 2, 0, 'Turkmen', '', 'pkg_tk-TM', 'package', '', 0, '3.5.0.2', '', 'https://update.joomla.org/language/details3/tk-TM_details.xml', '', ''),
(28, 2, 0, 'Irish', '', 'pkg_ga-IE', 'package', '', 0, '3.8.13.1', '', 'https://update.joomla.org/language/details3/ga-IE_details.xml', '', ''),
(29, 2, 0, 'Dzongkha', '', 'pkg_dz-BT', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/dz-BT_details.xml', '', ''),
(30, 2, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/sl-SI_details.xml', '', ''),
(31, 2, 0, 'Spanish CO', '', 'pkg_es-CO', 'package', '', 0, '3.9.0.1', '', 'https://update.joomla.org/language/details3/es-CO_details.xml', '', ''),
(32, 2, 0, 'German CH', '', 'pkg_de-CH', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/de-CH_details.xml', '', ''),
(33, 2, 0, 'German AT', '', 'pkg_de-AT', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/de-AT_details.xml', '', ''),
(34, 2, 0, 'German LI', '', 'pkg_de-LI', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/de-LI_details.xml', '', ''),
(35, 2, 0, 'German LU', '', 'pkg_de-LU', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/de-LU_details.xml', '', ''),
(36, 2, 0, 'English NZ', '', 'pkg_en-NZ', 'package', '', 0, '3.9.1.1', '', 'https://update.joomla.org/language/details3/en-NZ_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_update_sites`
--

DROP TABLE IF EXISTS `bf7gn_update_sites`;
CREATE TABLE `bf7gn_update_sites` (
...
--
-- Dumping data for table `bf7gn_update_sites`
--

INSERT INTO `bf7gn_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1544551602, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1544551603, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1544551603, '');

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_update_sites_extensions`
--

DROP TABLE IF EXISTS `bf7gn_update_sites_extensions`;
CREATE TABLE `bf7gn_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `bf7gn_update_sites_extensions`
--

INSERT INTO `bf7gn_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Table structure for table `bf7gn_usergroups`
--

DROP TABLE IF EXISTS `bf7gn_usergroups`;
CREATE TABLE `bf7gn_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `bf7gn_usergroups`
--

INSERT INTO `bf7gn_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `bf7gn_users`
--

DROP TABLE IF EXISTS `bf7gn_users`;
CREATE TABLE `bf7gn_users` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bf7gn_users`
--

INSERT INTO `bf7gn_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(921, 'Super User', 'admin', 'gord@arboreta.ca', '$2y$10$V0GNNPT576khEXwrRcTBqusETmEDFaWEvPx98pU/HkRgXUfHiHPPa', 0, 1, '2018-12-10 20:11:26', '2018-12-11 18:06:39', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_user_keys`
--

DROP TABLE IF EXISTS `bf7gn_user_keys`;
CREATE TABLE `bf7gn_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `bf7gn_user_notes`
--

DROP TABLE IF EXISTS `bf7gn_user_notes`;
CREATE TABLE `bf7gn_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bf7gn_user_profiles`
--

DROP TABLE IF EXISTS `bf7gn_user_profiles`;
CREATE TABLE `bf7gn_user_profiles` (
...
--
-- Table structure for table `bf7gn_user_usergroup_map`
--

DROP TABLE IF EXISTS `bf7gn_user_usergroup_map`;
CREATE TABLE `bf7gn_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bf7gn_user_usergroup_map`
--

INSERT INTO `bf7gn_user_usergroup_map` (`user_id`, `group_id`) VALUES
(921, 8);

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_utf8_conversion`
--

DROP TABLE IF EXISTS `bf7gn_utf8_conversion`;
CREATE TABLE `bf7gn_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `bf7gn_utf8_conversion`
--

INSERT INTO `bf7gn_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `bf7gn_viewlevels`
--

DROP TABLE IF EXISTS `bf7gn_viewlevels`;
CREATE TABLE `bf7gn_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `bf7gn_viewlevels`
--

INSERT INTO `bf7gn_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `bf7gn_action_logs`
--
ALTER TABLE `bf7gn_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_action_logs_extensions`
--
ALTER TABLE `bf7gn_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_action_logs_users`
--
ALTER TABLE `bf7gn_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indexes for table `bf7gn_action_log_config`
--
ALTER TABLE `bf7gn_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_assets`
--
ALTER TABLE `bf7gn_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_associations`
--
ALTER TABLE `bf7gn_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `bf7gn_banners`
--
ALTER TABLE `bf7gn_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_banner_clients`
--
ALTER TABLE `bf7gn_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `bf7gn_banner_tracks`
--
ALTER TABLE `bf7gn_banner_tracks`
...
--
-- Indexes for table `bf7gn_categories`
--
ALTER TABLE `bf7gn_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_contact_details`
--
ALTER TABLE `bf7gn_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `bf7gn_content`
--
ALTER TABLE `bf7gn_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `bf7gn_contentitem_tag_map`
--
ALTER TABLE `bf7gn_contentitem_tag_map`
...
--
-- Indexes for table `bf7gn_content_frontpage`
--
ALTER TABLE `bf7gn_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `bf7gn_content_rating`
--
ALTER TABLE `bf7gn_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `bf7gn_content_types`
--
ALTER TABLE `bf7gn_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `bf7gn_extensions`
--
ALTER TABLE `bf7gn_extensions`
...
--
-- Indexes for table `bf7gn_fields`
--
ALTER TABLE `bf7gn_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `bf7gn_fields_categories`
--
ALTER TABLE `bf7gn_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indexes for table `bf7gn_fields_groups`
--
ALTER TABLE `bf7gn_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `bf7gn_fields_values`
--
ALTER TABLE `bf7gn_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indexes for table `bf7gn_finder_filters`
--
ALTER TABLE `bf7gn_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `bf7gn_finder_links`
--
ALTER TABLE `bf7gn_finder_links`
...
--
-- Indexes for table `bf7gn_finder_links_terms0`
--
ALTER TABLE `bf7gn_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms1`
--
ALTER TABLE `bf7gn_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms2`
--
ALTER TABLE `bf7gn_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms3`
--
ALTER TABLE `bf7gn_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms4`
--
ALTER TABLE `bf7gn_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms5`
--
ALTER TABLE `bf7gn_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms6`
--
ALTER TABLE `bf7gn_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms7`
--
ALTER TABLE `bf7gn_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms8`
--
ALTER TABLE `bf7gn_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_terms9`
--
ALTER TABLE `bf7gn_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_termsa`
--
ALTER TABLE `bf7gn_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_termsb`
--
ALTER TABLE `bf7gn_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_termsc`
--
ALTER TABLE `bf7gn_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_termsd`
--
ALTER TABLE `bf7gn_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_termse`
--
ALTER TABLE `bf7gn_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_links_termsf`
--
ALTER TABLE `bf7gn_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `bf7gn_finder_taxonomy`
--
ALTER TABLE `bf7gn_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_finder_taxonomy_map`
--
ALTER TABLE `bf7gn_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `bf7gn_finder_terms`
--
ALTER TABLE `bf7gn_finder_terms`
...
--
-- Indexes for table `bf7gn_finder_terms_common`
--
ALTER TABLE `bf7gn_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `bf7gn_finder_tokens`
--
ALTER TABLE `bf7gn_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `bf7gn_finder_tokens_aggregate`
--
ALTER TABLE `bf7gn_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `bf7gn_finder_types`
--
ALTER TABLE `bf7gn_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `bf7gn_languages`
--
ALTER TABLE `bf7gn_languages`
...
--
-- Indexes for table `bf7gn_menu`
--
ALTER TABLE `bf7gn_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_menu_types`
--
ALTER TABLE `bf7gn_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `bf7gn_messages`
--
ALTER TABLE `bf7gn_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `bf7gn_messages_cfg`
--
ALTER TABLE `bf7gn_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `bf7gn_modules`
--
ALTER TABLE `bf7gn_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_modules_menu`
--
ALTER TABLE `bf7gn_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `bf7gn_newsfeeds`
--
ALTER TABLE `bf7gn_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `bf7gn_overrider`
--
ALTER TABLE `bf7gn_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_postinstall_messages`
--
ALTER TABLE `bf7gn_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `bf7gn_privacy_consents`
--
ALTER TABLE `bf7gn_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indexes for table `bf7gn_privacy_requests`
--
ALTER TABLE `bf7gn_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bf7gn_redirect_links`
--
ALTER TABLE `bf7gn_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `bf7gn_schemas`
--
ALTER TABLE `bf7gn_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `bf7gn_session`
--
ALTER TABLE `bf7gn_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `bf7gn_tags`
--
ALTER TABLE `bf7gn_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_template_styles`
--
ALTER TABLE `bf7gn_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `bf7gn_ucm_base`
--
ALTER TABLE `bf7gn_ucm_base`
...
--
-- Indexes for table `bf7gn_ucm_content`
--
ALTER TABLE `bf7gn_ucm_content`
...
--
-- Indexes for table `bf7gn_ucm_history`
--
ALTER TABLE `bf7gn_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `bf7gn_updates`
--
ALTER TABLE `bf7gn_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `bf7gn_update_sites`
--
ALTER TABLE `bf7gn_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `bf7gn_update_sites_extensions`
--
ALTER TABLE `bf7gn_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `bf7gn_usergroups`
--
ALTER TABLE `bf7gn_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_users`
--
ALTER TABLE `bf7gn_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bf7gn_user_keys`
--
ALTER TABLE `bf7gn_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `bf7gn_user_notes`
--
ALTER TABLE `bf7gn_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `bf7gn_user_profiles`
--
ALTER TABLE `bf7gn_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `bf7gn_user_usergroup_map`
--
ALTER TABLE `bf7gn_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `bf7gn_viewlevels`
--
ALTER TABLE `bf7gn_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `bf7gn_action_logs`
--
ALTER TABLE `bf7gn_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
-- AUTO_INCREMENT for table `bf7gn_action_logs_extensions`
--
ALTER TABLE `bf7gn_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `bf7gn_action_log_config`
--
ALTER TABLE `bf7gn_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `bf7gn_assets`
--
ALTER TABLE `bf7gn_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=70;
--
-- AUTO_INCREMENT for table `bf7gn_banners`
--
ALTER TABLE `bf7gn_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_banner_clients`
--
ALTER TABLE `bf7gn_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_categories`
--
ALTER TABLE `bf7gn_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `bf7gn_contact_details`
--
ALTER TABLE `bf7gn_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_content`
--
ALTER TABLE `bf7gn_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bf7gn_content_types`
--
ALTER TABLE `bf7gn_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `bf7gn_extensions`
--
ALTER TABLE `bf7gn_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10014;
--
-- AUTO_INCREMENT for table `bf7gn_fields`
--
ALTER TABLE `bf7gn_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_fields_groups`
--
ALTER TABLE `bf7gn_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_finder_filters`
--
ALTER TABLE `bf7gn_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_finder_links`
--
ALTER TABLE `bf7gn_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_finder_taxonomy`
--
ALTER TABLE `bf7gn_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bf7gn_finder_terms`
--
ALTER TABLE `bf7gn_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_finder_types`
--
ALTER TABLE `bf7gn_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `bf7gn_languages`
--
ALTER TABLE `bf7gn_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bf7gn_menu`
--
ALTER TABLE `bf7gn_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
--
-- AUTO_INCREMENT for table `bf7gn_menu_types`
--
ALTER TABLE `bf7gn_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bf7gn_messages`
--
ALTER TABLE `bf7gn_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_modules`
--
ALTER TABLE `bf7gn_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
--
-- AUTO_INCREMENT for table `bf7gn_newsfeeds`
--
ALTER TABLE `bf7gn_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_overrider`
--
ALTER TABLE `bf7gn_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `bf7gn_postinstall_messages`
--
ALTER TABLE `bf7gn_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `bf7gn_privacy_consents`
--
ALTER TABLE `bf7gn_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_privacy_requests`
--
ALTER TABLE `bf7gn_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_redirect_links`
--
ALTER TABLE `bf7gn_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_tags`
--
ALTER TABLE `bf7gn_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bf7gn_template_styles`
--
ALTER TABLE `bf7gn_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `bf7gn_ucm_content`
--
ALTER TABLE `bf7gn_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_ucm_history`
--
ALTER TABLE `bf7gn_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bf7gn_updates`
--
ALTER TABLE `bf7gn_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT for table `bf7gn_update_sites`
--
ALTER TABLE `bf7gn_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `bf7gn_usergroups`
--
ALTER TABLE `bf7gn_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `bf7gn_users`
--
ALTER TABLE `bf7gn_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=922;
--
-- AUTO_INCREMENT for table `bf7gn_user_keys`
--
ALTER TABLE `bf7gn_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_user_notes`
--
ALTER TABLE `bf7gn_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `bf7gn_viewlevels`
--
ALTER TABLE `bf7gn_viewlevels`
