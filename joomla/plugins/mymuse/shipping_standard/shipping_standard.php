<?php
/**
 * @version		$Id: shipping_standard.php 1930 2017-11-24 14:04:05Z gfisch $
 * @package		mymuse
            ...
            if($this->params->get($param)){
            	...
            	if($this->params->get("ship_all_countries_$i")){
            		...
            		if(isset($user_country)
            				&& in_array($user_country, (array)$this->params->get("ship_countries_$i"))){
            			//we have an exeption do not ship
            		}else{
            			$good = 1;
            		}
            	}elseif(isset($user_country) && in_array($user_country, (array)$this->params->get("ship_countries_$i"))){
            		$good = 1;
            	}
