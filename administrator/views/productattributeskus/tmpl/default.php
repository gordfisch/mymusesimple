...
?>
<h2><a href="index.php?option=com_mymuse&view=product&layout=listitems&subtype=item&id=<?php echo $this->parent->id; ?>"><?php echo JText::_('MYMUSE_RETURN_TO_ITEMS'); ?></a></h2>
