...
/**
 * Smart Search adapter for com_mymuse.
 *
 * @package     Joomla.Plugin
...
class PlgFinderMymuse extends FinderIndexerAdapter
{
	 ...
	 * @since  2.5
	 */
	protected $table = '#__mymuse_product';
	...
	/**
	 * Smart Search after save mymuse method.
	 * Reindexes the link information for a product that has been saved.
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_mymuse', true);
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_mymuse/helpers/route.php';
