...
<?php if (isset($this->item->product_made_date) && $this->item->product_made_date > 0) : ?>
	<dd class="product_made_date">
	<?php echo JText::_('MYMUSE_PRODUCT_CREATED_LABEL'); ?> :
	<?php echo JHtml::_('date', $this->item->product_made_date, $params->get('date_format', JText::_('DATE_FORMAT_LC3'))); ?>
	</dd>
<?php endif; ?>
