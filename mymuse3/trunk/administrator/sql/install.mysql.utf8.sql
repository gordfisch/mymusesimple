...
INSERT INTO `#__mymuse_country` (`id`, `plugin`, `country_name`, `country_3_code`, `country_2_code`) VALUES
...
(53, 'paypal', 'Croatia', 'HRV', 'HR'),
(54, '', 'Cuba', 'CUB', 'CU'),
(55, 'paypal', 'Cyprus', 'CYP', 'CY'),
(56, 'paypal', 'Czech Republic', 'CZE', 'CZ'),
(57, 'paypal', 'Denmark', 'DNK', 'DK'),
(58, '', 'Djibouti', 'DJI', 'DJ'),
(59, '', 'Dominica', 'DMA', 'DM'),
...
(66, '', 'Eritrea', 'ERI', 'ER'),
(67, 'paypal', 'Estonia', 'EST', 'EE'),
(68, '', 'Ethiopia', 'ETH', 'ET'),
(69, '', 'Falkland Islands (Malvinas)', 'FLK', 'FK'),
(70, '', 'Faroe Islands', 'FRO', 'FO'),
(71, '', 'Fiji', 'FJI', 'FJ'),
(72, 'paypal', 'Finland', 'FIN', 'FI'),
(73, 'paypal', 'France', 'FRA', 'FR'),
...
(79, '', 'Gambia', 'GMB', 'GM'),
(80, '', 'Georgia', 'GEO', 'GE'),
(81, 'paypal', 'Germany', 'DEU', 'DE'),
(82, '', 'Ghana', 'GHA', 'GH'),
(83, '', 'Gibraltar', 'GIB', 'GI'),
(84, 'paypal', 'Greece', 'GRC', 'GR'),
(85, '', 'Greenland', 'GRL', 'GL'),
(86, '', 'Grenada', 'GRD', 'GD'),
...
(116, '', 'Lao PDR', 'LAO', 'LA'),
(117, 'paypal', 'Latvia', 'LVA', 'LV'),
(118, '', 'Lebanon', 'LBN', 'LB'),
(119, '', 'Lesotho', 'LSO', 'LS'),
(120, '', 'Liberia', 'LBR', 'LR'),
(121, '', 'Libyan Arab Jamahiriya', 'LBY', 'LY'),
(122, 'paypal', 'Liechtenstein', 'LIE', 'LI'),
(123, 'paypal', 'Lithuania', 'LTU', 'LT'),
(124, 'paypal', 'Luxembourg', 'LUX', 'LU'),
(125, '', 'Macau', 'MAC', 'MO'),
...
(169, '', 'Pitcairn', 'PCN', 'PN'),
(170, 'paypal', 'Poland', 'POL', 'PL'),
(171, 'paypal', 'Portugal', 'PRT', 'PT'),
(172, '', 'Puerto Rico', 'PRI', 'PR'),
(173, '', 'Qatar', 'QAT', 'QA'),
(174, '', 'Reunion', 'REU', 'RE'),
(175, 'paypal', 'Romania', 'ROM', 'RO'),
...
(222, 'paypal', 'United Kingdom', 'GBR', 'GB'),
