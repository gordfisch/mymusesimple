 ...
 * View to edit
 */
class MymuseViewCoupon extends JView
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::help('', false, 'http://www.joomlamymuse.com/documentation/documentation-2-5/166-coupons-new-edit?tmpl=component');
