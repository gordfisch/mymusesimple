 ...
 * Mymuse model.
 */
class MymuseModelproductattributesku extends JModelAdmin
{
	/**
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Productattributesku', $prefix = 'MymuseTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_mymuse.edit.productattributesku.data', array());
